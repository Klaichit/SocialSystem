...
กฎชุดนี้คือสิ่งที่ทำให้ 41 เทมเพลตดูเป็นชุดเดียวกัน เพิ่มเทมเพลตใหม่ให้เดินตามนี้
...
และต้องเป็น **บล็อกแรก** ของสไลด์ ตัวมันวางแบบ absolute อยู่ใต้เนื้อหา (`z-index:1`)
